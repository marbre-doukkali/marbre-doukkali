...
st.markdown("<style>.stApp { background-color: #030712; background-image: radial-gradient(#ffffff 0.7px, transparent 1px); background-size: 35px 35px; color: #ffffff; font-family: 'Segoe UI', sans-serif; } .industrial-marble-m { display: flex; justify-content: center; align-items: flex-end; gap: 20px; padding: 40px; background: linear-gradient(180deg, #1f2937 0%, #030712 100%); border: 2px solid #4b5563; border-radius: 12px; margin-bottom: 30px; box-shadow: 0 10px 30px rgba(0,0,0,0.8); } .iron-pillar { width: 50px; background: linear-gradient(90deg, #e2e8f0 0%, #94a3b8 50%, #475569 100%); border: 2px solid #64748b; border-radius: 3px; box-shadow: 5px 5px 15px rgba(0,0,0,0.6), inset -3px -3px 6px rgba(0,0,0,0.4); } .col-1 { height: 130px; } .col-2 { height: 85px; background: linear-gradient(90deg, #94a3b8 0%, #475569 100%); } .col-3 { height: 45px; background: linear-gradient(90deg, #64748b 0%, #1e293b 100%); } .col-4 { height: 85px; background: linear-gradient(90deg, #94a3b8 0%, #475569 100%); } .col-5 { height: 130px; } .industrial-title { font-size: 30px; font-weight: bold; color: #ffffff; text-align: center; margin-top: 15px; text-shadow: 2px 2px 4px #000000; } h1, h2, h3 { color: #ffffff !important; text-shadow: 1px 1px 3px #000000; text-align: right; border-bottom: 1px solid #374151; padding-bottom: 8px; } .stButton>button { background-color: #1f2937 !important; color: #ffffff !important; border: 2px solid #cbd5e1 !important; border-radius: 6px; font-weight: bold; font-size: 16px; padding: 8px 20px; } .stButton>button:hover { background-color: #ffffff !important; color: #030712 !important; border: 2px solid #ffffff !important; } div[data-testid='stSidebar'] { background-color: #0f172a !important; } .marble-panel { background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%); color: #0f172a !important; padding: 25px; border-radius: 12px; border-left: 8px solid #475569; margin-bottom: 25px; box-shadow: 0 10px 25px rgba(0,0,0,0.5); }</style>", unsafe_allow_html=True)
...
if page == "📝 تسجيل الطلبيات الجديدة":
    ...
    if st.session_state["panier_actuel"]:
        ...
        with col_act2:
            ...
            html_invoice += "</head><body onload='window.print();'>"
